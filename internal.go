...
// var (
// 	Discard = NewInternal(log.New(io.Discard, "", log.LstdFlags), config{})
// 	Default = NewInternal(log.New(os.Stdout, "\r\n", log.LstdFlags), config{
...
// // New
// func NewInternal(writer writer, config config) logger.Interface {
// 	var (
// 		infoStr      = "%s\n[info] "
// 		warnStr      = "%s\n[warn] "
// 		errStr       = "%s\n[error] "
